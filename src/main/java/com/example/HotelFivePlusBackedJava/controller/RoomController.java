...
import java.util.List;
    ...
    public class RoomController {
        ...
        @Autowired
        private IBookingsService iBookingService;
        ...
        public List<String> getRoomTypes() {
            return (List<String>) roomService.getAllRooms();
        }
        ...
        public ResponseEntity<Response> getAvailableRooms() {
            Response response = roomService.getAllAvailableRoom();
            return ResponseEntity.status(response.getStatusCode()).body(response);
        }
        ...
        public ResponseEntity<Response> getAvailableRoomsByDateAndType(
            ...
            Response response = roomService.getAllAvailableRoomsByDateAndRoomType(checkInDate, checkOutDate, roomType);
            return ResponseEntity.status(response.getStatusCode()).body(response);
        }
